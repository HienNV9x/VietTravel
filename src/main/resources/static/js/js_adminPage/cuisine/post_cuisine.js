...
function createCourse(data, callback){			  	
  ...
  fetch(cuisineApi, options)							//truyền thông tin được tạo ở trên vào API courseApi
...
function handleCreateForm(){ 
  ...
  createBtn.onclick = function(event){	
     ...
     var titleCuisine = document.querySelector('input[name="titleCuisine"]').value;			//lấy giá trị phần tử input có tên là name và gán vào biến title
     var contentCuisine = document.querySelector('input[name="contentCuisine"]').value;
     var locationCuisine = document.querySelector('input[name="locationCuisine"]').value;	//lấy giá trị phần tử input có tên là age và gán vào biến content
