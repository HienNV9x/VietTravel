  ...
  e(".accordion_styled").on(
    ...
    e(function () {
      ...
      e(window).on("scroll", function () {
        ...
        //-------------------------------------
        // e(".numbers-row").append(
        //   '<div class="inc button_inc">in</div><div class="dec button_inc">out</div>'
        // ),
        // e(".button_inc").on("click", function () {
        //   var button = $(this),
        //       currentValue = parseFloat(button.parent().find("input").val());
        //   if (button.text() === "in") {
        //       var newValue = currentValue + 1;
        //   } else if (button.text() === "out") {
        //       var newValue = currentValue > 1 ? currentValue - 1 : 0;
        //   }
    ...
    e(".search-overlay-menu, .search-overlay-menu .search-overlay-close").on(
      "click keyup",
      function (o) {
        (o.target == this ||
